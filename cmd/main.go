...
func init() {
	...
	utilruntime.Must(ingestv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "34e5749d.sluice.dev",
	...
	if err := (&controller.IngestionSourceReconciler{
		Client:      mgr.GetClient(),
		Scheme:      mgr.GetScheme(),
		Recorder:    mgr.GetEventRecorder("ingestionsource-controller"),
		WorkerImage: workerImage,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "ingestionsource")
		os.Exit(1)
	}
